...
#SBATCH --job-name=oco_regstruct_fp
...
# Regime-aware structured-residual wrapper for the default 10 km reference.
# Reuses curc_shell_blanca_train_structured_shared_foldpca_2016_2020.sh.
