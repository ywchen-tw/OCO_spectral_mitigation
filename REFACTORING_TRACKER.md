...
```bash
# 1. Fit pipeline once
python src/pipeline.py --data results/csv_collection/combined_2020-01-01_all_orbits.csv --sfc-type 0 --out results/train_data/exp_v1/pipeline_202001.pkl
...
python src/models_transformer.py --pipeline results/exp_v1/pipeline.pkl --suffix exp_v1
