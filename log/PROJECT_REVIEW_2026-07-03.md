...
- **Dead/stale code misleads readers:** `deep_ensemble.py.bak`; unused `get_design_matrix` (`fitting.py:433`); retracted-caveat comments in `compare_profile_features.py:14` (M8); large commented-out feature blocks in `pipeline.py:284-430`. Delete — git history keeps them.
