...
1. **Collocation/geometry schematic + decay curves**
   - (a) schematic (real data, orbit 29252 2020-01-01, annotated nearest-cloud
   ...
   - *Suggested caption:* **Figure 1.** (a) Collocation geometry for one
     OCO-2 glint granule (orbit 29252, 1 January 2020): Aqua-MODIS MYD35
     ...
     nearest cloudy pixel (d = 23.1 km); inset: full granule track.
