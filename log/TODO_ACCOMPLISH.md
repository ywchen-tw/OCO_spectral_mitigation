...
- [ ] **Manuscript figure pass (style LOCKED 2026-07-09; user-approved on 3
  ...
  - [x] **Missing budget figures CREATED (2026-07-11)** — five new composed
        figures via `manuscript/scripts/make_*.py` (moved from
        `workspace/manuscript_figures/` 2026-07-21), all rendered,
...
`manuscript/scripts/make_*.py`, moved 2026-07-21; outputs now under
`manuscript/figures/`):**
