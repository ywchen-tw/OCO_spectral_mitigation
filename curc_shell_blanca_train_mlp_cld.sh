...
python src/mlp_lr_cloud_classifier.py --pipeline results/train_data/pipeline_land_2016_2020.pkl \
 --sfc_type 1 --suffix land_2016_2020_5

# python src/mlp_lr_cloud_classifier.py --pipeline results/train_data/pipeline_ocean_2016_2020.pkl \
