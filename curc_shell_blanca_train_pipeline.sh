...
python src/pipeline.py --data results/csv_collection/combined_2019_dates.parquet \
--sfc-type 0 --out results/train_data/pipeline_ocean_2019.pkl

python src/pipeline.py --data results/csv_collection/combined_2019_dates.parquet \
--sfc-type 1 --out results/train_data/pipeline_land_2019.pkl