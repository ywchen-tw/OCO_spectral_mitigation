...
#SBATCH --job-name=oco_train_linreg_foldpca_r15
...
# ── Ridge linear baseline (LAND, 15 km target) — SAME protocol as the production
# DE, for the reviewer-proof baseline table (log/archive/LINREG_XGB_BASELINE_PLAN_2026-07-07.md).
# Land twin of curc_shell_blanca_linreg_foldpca_r05.sh: --sfc_type 1 --target 15km,
...
# Suffix: linreg_land_full_prof_foldpca_r15_f${F}
#
# PREREQUISITES:
...
#     --dirs 'results/model_linear_baseline/linreg_land_full_prof_foldpca_r15_f*' \
#     --label LinReg+foldpca+r15 \
#     --out results/model_comparison/linreg_land_foldpca_r15_kfold_agg.md
...
python -m models.linear_baseline --sfc_type 1 --suffix linreg_land_full_prof_foldpca_r15_f${F} \
