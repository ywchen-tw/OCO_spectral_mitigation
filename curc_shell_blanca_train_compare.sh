...
python src/apply_model_with_cld.py \
  ...
  --input     combined_2021-12-29_all_orbits.parquet combined_2018-10-24_all_orbits.parquet combined_2020-01-15_all_orbits.parquet combined_2021-04-24_all_orbits.parquet combined_2019-07-10_all_orbits.parquet \
  --output    corrected.csv \
  --plot-dir  results/model_comparison/land_2016_2020_4_cld
...
python src/apply_model_with_cld.py \
  ...
  --xgb-dir    results/model_xgb/ocean_2016_2020_4/ \
  --hybrid-dir results/model_hybrid/ocean_2016_2020_4/ \
  --clf-dir    results/model_mlp_clf/ocean_2016_2020_4/ \
  --ft-clf-dir results/model_ft_clf/ocean_2016_2020_4/ \
  --gate-clf   ft_clf \
  --input-dir  results/csv_collection \
  --input     combined_2020-02-11_all_orbits.parquet combined_2018-11-29_all_orbits.parquet combined_2020-05-01_all_orbits.parquet combined_2020-03-30_all_orbits.parquet combined_2020-09-06_all_orbits.parquet combined_2018-09-01_all_orbits.parquet combined_2018-09-02_all_orbits.parquet combined_2019-03-13_all_orbits.parquet \
  --output    corrected.csv \
  --plot-dir  results/model_comparison/ocean_2016_2020_4_cld