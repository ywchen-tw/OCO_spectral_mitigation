...
# Only the ACTIVE features are listed.  Candidates that were evaluated and
# excluded live in git history (pre-2026-07 versions of this file kept them as
# inline comments).  Rationales worth keeping: co2_ratio_bc (ocean) SHAP≈0.001;
# aod_total SHAP=0.006, redundant with the per-component AODs; aod_bc SHAP=0.
