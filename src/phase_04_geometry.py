...
class GeometryProcessor:
    ...
    def visualize_kdtree_spatial_range(self,
        ...
        ax.text(0.5, 0.5, f'Total Footprints: {len(fp_lats):,}\n'
                            ...
                            f'Footprint ≤ 4 km percentage: {100 *  np.sum(fp_distances_array <= 4) / len(fp_lats):.2f}%\n'
                            f'Footprint ≤ 10 km percentage: {100 * np.sum(fp_distances_array <= 10) / len(fp_lats):.2f}%\n'
                            f'Footprint ≤ 15 km percentage: {100 * np.sum(fp_distances_array <= 15) / len(fp_lats):.2f}%\n'
                            f'\n'
