...
def rdabs_species_absco(absco_data, species):
    """
    ...
    tk_species = absco_data['Temperature']

    # Read in the Wavenumber grid
    wcm_species = absco_data['Wavenumber']

    # Read in the Broadener VMRs
    broad_species = absco_data['Broadener_01_VMR']
