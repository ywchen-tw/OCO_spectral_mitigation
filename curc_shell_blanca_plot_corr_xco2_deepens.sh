...
run_case() {
    ...
    # freshly synced from CURC.  IMPORTANT locally: a rebuild here would also
    # OVERWRITE the synced files without the --emit-members mu_XX columns the
    # uncertainty layer needs.  Falls through to a build when the file is absent.
